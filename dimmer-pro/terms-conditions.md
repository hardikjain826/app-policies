...
Please read these terms and conditions carefully before using the **Dimmer Pro** application operated by **Intentional Labs**.
...
Dimmer Pro is a screen dimming application that uses an overlay and Android's Accessibility Service to reduce screen brightness below the system minimum. The app operates entirely on your device. The effectiveness of screen dimming may vary depending on your device manufacturer, Android version, and system settings. We do not guarantee compatibility with all devices or third-party launchers.
